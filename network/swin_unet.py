"""
cited by Cao, Hu, et al. "Swin-unet: Unet-like pure transformer for medical image segmentation." European conference on computer vision. Cham: Springer Nature Switzerland, 2022.
"""
import torch
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None):
        ...
        if norm_layer is not None:
            self.norm = norm_layer(embed_dim)  # normalized_shape=embed_dim
        else:
            self.norm = None
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=112, patch_size=2, in_chans=1, num_classes=2,
        ...
        if self.final_upsample == "expand_first":
            ...
            self.up = FinalPatchExpand_X2(input_resolution=(img_size // patch_size, img_size // patch_size),
